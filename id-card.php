            ...
            $html .= "
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  ...
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
                                                      <p style='font-size: 14px;'>Senior High School Student</p>
                                                  </div>
                                                  <div class='box-3'>
            ...
            <div class="card jumbotron">
                <div class="card-body">
                    <form class="form" method="POST" action="id-card.php">
                        ...
                        <input class="form-control mr-sm-2" type="search" placeholder="Enter LRN No." name="id_no">
                        <small id="emailHelp" class="form-text text-muted">Every student's should have LRN No.</small>
                        <br>
